    ...
    <div class="row">
        ...
        <div class="col-lg-6">
            ...
            <div class="card mb-4 vh-100">
                <div class="card-header">Realtime Mutant Explorer</div>
                    <div class="card-body">
        ...
        <div class="col-lg-6">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-6">
                        <!-- Bar chart example-->
                        <div class="card mb-4">
                            <div class="card-header">DeltaG Explorer</div>
                            <div class="card-body">
                    ...
                    <div class="col-lg-6">
                        <!-- Pie chart example-->
                        <div class="card mb-4">
                            <div class="card-header">Anchor Point Explorer</div>
                            <div class="card-body">
                                <div class="chart-pie"><div class="chartjs-size-monitor"><div class="chartjs-size-monitor-expand"><div class=""></div></div><div class="chartjs-size-monitor-shrink"><div class=""></div></div></div><canvas id="myPieChart" width="408" height="240" class="chartjs-render-monitor" style="display: block; width: 408px; height: 240px;"></canvas></div>
                            </div>
                            <div class="card-footer small text-muted">Updated yesterday at 11:59 PM</div>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-6">
                        <!-- Bar chart example-->
                        <div class="card mb-4">
                            <div class="card-header">Trajectory RMSD</div>
                            <div class="card-body">
                                <div class="chart-bar"><div class="chartjs-size-monitor"><div class="chartjs-size-monitor-expand"><div class=""></div></div><div class="chartjs-size-monitor-shrink"><div class=""></div></div></div><canvas id="myBarChart" width="408" height="240" class="chartjs-render-monitor" style="display: block; width: 408px; height: 240px;"></canvas></div>
                            </div>
                            <div class="card-footer small text-muted">Updated yesterday at 11:59 PM</div>
                    ...
                    <div class="col-lg-6">
                        <!-- Bar chart example-->
                        <div class="card mb-4">
                            <div class="card-header">Principal Component Analysis</div>
                            <div class="card-body">
                                <div class="chart-bar"><div class="chartjs-size-monitor"><div class="chartjs-size-monitor-expand"><div class=""></div></div><div class="chartjs-size-monitor-shrink"><div class=""></div></div></div><canvas id="myBarChart" width="408" height="240" class="chartjs-render-monitor" style="display: block; width: 408px; height: 240px;"></canvas></div>
                            </div>
                            <div class="card-footer small text-muted">Updated yesterday at 11:59 PM</div>
                    ...
                    <div class="col-lg-6">
                        <!-- Bar chart example-->
                        <div class="card mb-4">
                            <div class="card-header">Trajectory Contacts Heatmap</div>
                            <div class="card-body">
                                <div class="chart-bar"><div class="chartjs-size-monitor"><div class="chartjs-size-monitor-expand"><div class=""></div></div><div class="chartjs-size-monitor-shrink"><div class=""></div></div></div><canvas id="myBarChart" width="408" height="240" class="chartjs-render-monitor" style="display: block; width: 408px; height: 240px;"></canvas></div>
                            </div>
                            <div class="card-footer small text-muted">Updated yesterday at 11:59 PM</div>
